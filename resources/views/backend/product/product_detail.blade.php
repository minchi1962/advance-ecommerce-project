...
@section('admin')
    ...
    <div class="container-full">
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title">Product Detail View</h4>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_en" class="form-control"
                                                            value="Small, Medium, Large, XL" data-role="tagsinput"
                                                            placeholder="add tags" required=''
                                        ...
                                        <div class="row"> {{-- start 5th row --}}
                                            <div class="col-md-6"> {{-- start md-4 --}}
                                                <div class="form-group">
                                                    <h5>Product Color En <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_color_en" class="form-control"
                                                            value="Red, Black, Green, Yellow" data-role="tagsinput"
                                                            placeholder="add tags" required=''
                                        ...
                                        <div class="row"> {{-- start 7th row --}}
                                            <div class="col-md-6"> {{-- start md-6 --}}
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <textarea name="
                                                        short_descp_en" id="short_descp_en" class="form-control"
                                            ...
                                            <div class="col-md-6"> {{-- start md-6 --}}
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <textarea name="
                                                        short_descp_hin" id="short_descp_hin" class="form-control"
                                                        required='' placeholder="Textarea text">{!! $products->short_descp_hin !!}
                                                        </textarea>
                                                    </div>
                                                </div>
                                            </div> {{-- end col-md-6 --}}
                                        ...
                                        <div class="row"> {{-- start 8th row --}}
                                            <div class="col-md-6"> {{-- start md-6 --}}
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea id="editor" name="long_descp_en" rows="10" cols="80"
                                                            required=''>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card">
                                            <img src="{{ asset($img->photo_name) }}" class="card-img-top"
                                                style="height:130px; height: 280px">
                                            <div class="card-body">
                                                <h5 class="card-title">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                ...
                                                <input type="" name="product_thambnail" class="form-control"
        ...
        {{-- End of Thambnail Image Section --}}
    </div>
