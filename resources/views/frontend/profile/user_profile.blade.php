            ...
            <div class="row">
                <div class="col-md-2"><br>
                    <img class="card-img-top" style="border-radius: 50%"
                        src="{{ !empty($userData->profile_photo_path) ? url('upload/admin_images/' . $userData->profile_photo_path) : url('upload/no_image.jpg') }}"
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('user.profile.store') }}" enctype="mu">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label class="info-title" for="exampleInputEmail1">User Image
                                        <span>*</span></label>
